...
<!DOCTYPE html>
    <html>
      <head>
        ...
        <style>
          ...
          .stats {
                  ...
                  pointer-events: none; /* So it doesn't block mouse pan/tilt */
          ...
          .stat-item {
                  ...
                  font-size: 1.2em;
                  font-weight: bold;
                  color: #00ffcc; /* Neon green/blue for a "tech" feel */
                  margin: 4px 0;
                  }
      ...
      <body>
        ...
        <div class="stats">
        <div class="stat-item">
            <span class="stat-label">TEMP:</span><span id="temp-val">--</span>°F
        </div>
        <div class="stat-item">
            <span class="stat-label">HUMID:</span><span id="hum-val">--</span>%
        </div>
          </div>
 ...
 async function updateEnvironmentalStats() {
         try {
